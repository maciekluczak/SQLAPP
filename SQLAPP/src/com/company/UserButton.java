...
public class UserButton extends JLabel implements MouseListener {
    ...
    public UserButton(int BackButtonWidth, int BackButtonHeight){
        ...
        imageLabelAnimated = new ImageIcon("image\\user.png");
