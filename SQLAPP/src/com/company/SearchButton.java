...
public class SearchButton extends JLabel implements MouseListener {
    ...
    public SearchButton(int BackButtonWidth, int BackButtonHeight){
        ...
        ImageIcon image = new ImageIcon("image\\search1.png");
        ...
        imageLabelAnimated = new ImageIcon("image\\search1.png");
